...
func (cu *CardUpdate) SetCardholderName(s string) *CardUpdate {
	cu.mutation.SetCardholderName(s)
	return cu
}

// SetValidUntil sets the "valid_until" field.
func (cu *CardUpdate) SetValidUntil(s string) *CardUpdate {
	cu.mutation.SetValidUntil(s)
	return cu
}
...
func (cu *CardUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.CardholderName(); ok {
		_spec.SetField(card.FieldCardholderName, field.TypeString, value)
	}
	if value, ok := cu.mutation.ValidUntil(); ok {
...
// SetCardholderName sets the "cardholder_name" field.
func (cuo *CardUpdateOne) SetCardholderName(s string) *CardUpdateOne {
	cuo.mutation.SetCardholderName(s)
	return cuo
}

// SetValidUntil sets the "valid_until" field.
func (cuo *CardUpdateOne) SetValidUntil(s string) *CardUpdateOne {
	cuo.mutation.SetValidUntil(s)
	return cuo
}
...
func (cuo *CardUpdateOne) sqlSave(ctx context.Context) (_node *Card, err error) {
	...
	if value, ok := cuo.mutation.CardholderName(); ok {
		_spec.SetField(card.FieldCardholderName, field.TypeString, value)
	}
	if value, ok := cuo.mutation.ValidUntil(); ok {
		_spec.SetField(card.FieldValidUntil, field.TypeString, value)
	}
